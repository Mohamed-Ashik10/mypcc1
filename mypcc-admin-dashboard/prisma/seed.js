...
async function main() {
    ...
    const devotionals = Array.from({ length: 30 }).map((_, i) => {
        ...
        d.setDate(d.getDate() - i);
        return {
            title: i === 0 ? 'Still Waters' : `Spiritual Depth Day ${30-i}`,
            date: d,
            content: `The Lord is my shepherd; I shall not want. He maketh me to lie down in green pastures... [Day ${i+1} of reflections]`,
            author: 'Pastor James',
    ...
    const echoIssues = [
        {
            ...
            issueMonth: new Date(2026, 2, 27),
            pdfUrl: 'https://pcc.org/echo/march2026.pdf',
            coverUrl: 'https://images.unsplash.com/photo-1529070538774-1843cb3265df?auto=format&fit=crop&w=800&q=80',
            isFeatured: true,
            category: 'Testimony',
            excerpt: 'Latest issue of The Echo for March 2026.',
            fullText: 'Stories of faith, testimonies, church news and the voices that echo across our community.'
        },
        {
            title: 'Strength in Community',
            issueMonth: new Date(2026, 1, 15),
            pdfUrl: 'https://pcc.org/echo/feb2026.pdf',
            coverUrl: 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?auto=format&fit=crop&w=800&q=80',
            isFeatured: false,
            category: 'Community',
            excerpt: 'February 2026 Community highlights.',
            fullText: 'Our community joined together to rebuild the local nursery...'
        }
    ];
