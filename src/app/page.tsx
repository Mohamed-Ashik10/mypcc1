...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 text-center transition-colors duration-300 relative overflow-hidden">
      <VantaBackground />

      <div className="max-w-2xl w-full bg-white/80 dark:bg-slate-900/80 backdrop-blur-md rounded-3xl shadow-2xl p-12 space-y-8 animate-in fade-in zoom-in duration-700 border border-white/20 dark:border-slate-800/50 z-10">
