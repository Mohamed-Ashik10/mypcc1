...
function LoginForm() {
    ...
    return (
        <div className="w-full max-w-md space-y-8 bg-slate-900/40 backdrop-blur-2xl p-8 rounded-[40px] shadow-[0_20px_60px_rgba(0,0,0,0.5)] border border-white/10 animate-in fade-in zoom-in duration-700 z-10">
